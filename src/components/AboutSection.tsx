...
function AboutSection() {
	return (
		<section className="text-wrap place-self-start grid grid-flow-row gap-4">
			...
			por onde passar. Sou uma pessoa sonhadora e
			determinada, e meus projetos sempre refletem
			essa atitude. Dou prioridade à durabilidade,
			escalabilidade e desempenho, para que eu
			possa me orgulhar do meu trabalho e, ao
			mesmo tempo, entregar software de qualidade,
